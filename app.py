...
def plot_forecast(forecast_df: pd.DataFrame) -> go.Figure:
    ...
    fig = go.Figure()
    stream_cfg = {
        "oil_waste":     {"name": "Used Oil",     "color": "#f97316", "fill": "rgba(249,115,22,0.10)"},
        "coolant_waste": {"name": "Coolant",       "color": "#38bdf8", "fill": "rgba(56,189,248,0.10)"},
        "acid_waste":    {"name": "Battery Acid",  "color": "#a78bfa", "fill": "rgba(167,139,250,0.10)"},
    }
